            ...
            <div class="col-12 py-3">
                ...
                if (isset($_GET['id'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo '<input type="text" class="form-control" id="judul" name="judul" value="' . $nama . '" required>';
                        echo '</div>';

                        echo '<div class="form-group">';
                        echo '<label for="tanggal">Tanggal:</label>';
                        echo '<input type="date" class="form-control" id="tanggal" name="tanggal" value="' . $jabatan . '" required>';
                        echo '</div>';

                        echo '<div class="form-group">';
                        echo '<label for="lokasi">Lokasi Acara:</label>';
                        echo '<input type="text" class="form-control" id="lokasi" name="lokasi" value="' . $nip . '" required>';
                        echo '</div>';
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE pemerintahan SET nama='$judul', jabatan='$tanggal', nip='$lokasi' WHERE id=$id";
